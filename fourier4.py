...
def generate_random_shape(num_sym=None, num_points=None, num_corners=None, amp_low=None, amp_high=None, seed=None):
    ...
    """
    Fourier4 update here. Instead of always performing a linear interpolation
    in radius, randomly choose this method or an ellipse-based method between
    angles.
    
    """
    method_selector = random.randint(0, 10)
    if method_selector > 5:
        # Interpolate method
    ...
    # TODO This needs to be updated for the ellipse-based method
    x = r * np.cos(t)
    y = r * np.sin(t)
    shape_points = x + 1j * y
